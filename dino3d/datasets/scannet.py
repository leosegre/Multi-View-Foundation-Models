...
import dino3d
from dino3d.utils import get_depth_tuple_transform_ops, get_tuple_transform_ops
from dino3d.utils.transforms import GeometricSequential
...
class ScanNetScene:
    ...
    def __getitem__(self, pair_idx):
        ...
        data_dict["intrinsics"] = torch.stack([K1, K2])
        data_dict["extrinsics"] = torch.stack([T1, T2])
        return data_dict
...
class ScanNetBuilder:
    ...
    def build_scenes(self, split = 'train', min_overlap=0., **kwargs):
        ...
        scenes = []
        for scene_name in tqdm(scene_names, disable =dino3d.RANK > 0):
