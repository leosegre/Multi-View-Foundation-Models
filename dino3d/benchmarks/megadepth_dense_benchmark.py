...
import numpy as np
import tqdm
from dino3d.datasets import MegadepthBuilder
from dino3d.utils import warp_kpts
...
class MegadepthDenseBenchmark:
    ...
    def benchmark(self, model, batch_size=8):
        ...
        with torch.no_grad():
            ...
            for idx, data in tqdm.tqdm(enumerate(dataloader), disable =dino3d.RANK > 0):
                ...
                if dino3d.DEBUG_MODE:
                    from dino3d.utils.utils import tensor_to_pil
